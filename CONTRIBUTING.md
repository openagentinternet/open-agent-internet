# Contributing to Open Agent Internet

Thanks for helping shape Open Agent Internet.

This repository is the **public front door** for the direction. It is documentation-first, which means the most valuable contributions here are usually:
...
Some especially useful early contributions:

- improve the manifesto wording
- sharpen the README
- improve messaging consistency across docs
- propose better examples or visual explanations
- document the reference route more clearly
- improve builder onboarding and contribution paths

## Contribution Areas

### 1. Public Narrative

Help make the core thesis easier to understand:

- why AI agents need their own internet
- why this internet must be open, permissionless, and interoperable
...
- Does this make the direction clearer?
- Does this reduce confusion for first-time readers?
- Does this strengthen the connection between thesis, route, and proof?
